...
export interface LlmRunner {
  ...
  generateFiles(options: LlmGenerateFilesRequestOptions): Promise<LlmGenerateFilesResponse>;

  /** Sends a normal text generation request to the LLM. */
  generateText(options: LlmGenerateTextRequestOptions): Promise<LlmGenerateTextResponse>;
 ...
 * request to an LLM.
 */
export interface LlmConstrainedOutputGenerateRequestOptions<T extends z.ZodTypeAny = z.ZodTypeAny>
...
export interface LlmConstrainedOutputGenerateResponse<T extends z.ZodTypeAny = z.ZodTypeAny> {
